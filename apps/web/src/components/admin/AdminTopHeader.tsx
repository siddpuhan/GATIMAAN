...
import { useSocketStatus } from '../../hooks/useRealtime.js';
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-50 border border-slate-200 text-[11px] text-slate-600 font-medium">
            ...
            />
            <span>{isSocketConnected ? 'System Online' : 'Reconnecting'}</span>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            <div className="hidden md:flex flex-col text-right">
              ...
              <div className="flex items-center justify-end gap-1.5 mt-0.5">
                ...
                <Badge variant="navy" size="sm" className="text-[9px] px-1 py-0 uppercase">
                  {((user?.publicMetadata as { role?: string })?.role || 'ADMIN').toUpperCase()}
                </Badge>
              </div>
            </div>
